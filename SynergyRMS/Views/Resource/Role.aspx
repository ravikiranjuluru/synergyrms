...
<table cellspacing="0" cellpadding="0" class="" style="border: medium none; width: 100%;" id="tabTablectl00_phTabstripHeader_tabMain">
	...
	<tr>
		...
		<td class="tabSpace"><img height="1" width="1" id="ctl00_phTabstripHeader_tabMain_imgTabSpace0" src="/images/space.gif"></td>
...
<tbody><tr>
    ...
    <tr>
        ...
        <td valign="middle" align="left" class="formDetail">
            <select onchange="changeResourceType(2);" disabled="disabled" class="comboBox" id="ctl00_phFormContent_cboResourceType" name="ctl00$phFormContent$cboResourceType">
