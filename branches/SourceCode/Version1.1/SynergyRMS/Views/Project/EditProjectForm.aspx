...
<body>
    ...
    <% using (Html.BeginForm("EditProject", "Project"))
       { %>
    <table style="height: 431px; width: 532px">
                                                    ...
                                                    <table cellspacing="0" cellpadding="0" border="0" style="border-collapse: collapse;
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td valign="middle" align="left" tyle="width:80%">
                                                                    ...
                                                                    <% if (status == "Success")
                                                                       { %>
                                                                    <div id="msgsuccess" class="success-msg" tyle="width:80%">
                                                                        <%= msg%></div>
                                                                    <%} %>
                                                                    <% if (status == "Error")
                                                                       { %>
                                                                    <div id="msgerror" class="error-msg" style="width: 80%">
                                                                        <%= msg%></div>
                                                                    <%} %>
                                                                    <%} %>
                                                                </td>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="formDetail" align="left" valign="top">
                                                                    ...
                                                                    <%--<%=Html.DropDownList("ddProTypes", (SelectList)ViewData["ProTypes"], project.PM_Types.TypeId,new { @class = "comboBox" })%>--%>
                                                                    <%=Html.DropDownList("ddProTypes", (SelectList)ViewData["ProTypes"], new { @class = "comboBox" })%>
                                                                </td>
                                                            </tr>
                                                            <%} %>
                                                            <tr>
                                                                ...
                                                                <td class="formDetail" align="left" valign="top">
                                                                    <input name="projectstartdate" id="projectstartdate" class="textBox" size="15" maxlength="4"
                                                                        type="text" value="<%=String.Format("{0:MM/dd/yyyy}", project.ProjectStartDate).Replace("-","/")%>">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td class="formDetailDark" align="right" valign="middle">
                                                                ...
                                                                <td class="formDetail" align="left" valign="top">
                                                                    <input name="projectenddate" id="projectenddate" class="textBox" size="15" maxlength="4"
                                                                        type="text" value="<%=String.Format("{0:MM/dd/yyyy}", project.ProjectEndDate).Replace("-","/")%>">
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td height="5" class="style2">
