...
(function(f, d) {
    if (!f.Spook) {
        var g = f.Spook = function(a) { g.init(a) }, i = function() { var a = arguments[0] || {}, b = 1, c = arguments.length, e = false, h; if (typeof a === "boolean") { e = a; a = arguments[1] || {}; ++b } if (typeof a !== "object" && Object.prototype.toString.call(a) !== "[object Function]") a = {}; for (; b < c; b++) if ((h = arguments[b]) !== null) for (var j in h) { var m = a[j], l = h[j]; if (a !== l) if (e && l && typeof l === "object" && !l.nodeType) a[j] = i(e, m || (l.constructor == Array ? [] : {}), l); else if (l !== d) a[j] = l } return a }, k = function() { }; i(g, { options: {},
            ...
            }, active: false, animations: [], blockClick: 0, cache: {}, cacheCt: 0, captionTimer: null, current: -1, dimensions: {}, expando: "SpookCacheKey", externals: {}, gallery: [], lang: { en: { of: "of", loading: "loading",
...
a.Tbar + '<div id="{}Title"></div></div></div><div id="{}Body"><div id="{}BodyWrap"><div id="{}BodyInner"></div><div id="{}Load"><div></div></div><div id="{}Caption"><div id="{}CaptionInner" class="{}CaptionInner"></div></div><div id="{}CaptionHide"><div id="{}CaptionInnerHide" class="{}CaptionInner"></div></div></div></div><div id="{}Bbar"><div id="{}BbarInner">' + a.Bbar + '<div id="{}Counter"><a id="{}Click-first" class="{}ClickNav {}AlphaPNG" onclick="{}.change(0)"></a><div id="{}CounterInner"></div><a id="{}Click-last" class="{}ClickNav {}AlphaPNG" onclick="{}.change(-9)"></a></div><div id="{}BbarClear"></div></div></div></div></div>').replace(/\{\}/g,
...
a), "SpookHide", !!b)
            }, sWrapEl: function() { return this.Get("") }
