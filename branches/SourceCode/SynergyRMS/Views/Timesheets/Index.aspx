                                ...
                                <td onclick="var newWindow = window.open('/reporting/rep_contextreport.aspx?Key=10','','toolbar=no,location=no,status=yes,menubar=yes,scrollbars=yes,resizable=yes');newWindow.focus();" style="white-space: nowrap; cursor: pointer; background-color: rgb(249, 249, 249); color: rgb(102, 102, 102);" class="popupMenuItem">
                                    Print My Weekly Timesheet
                                            ...
                                            <td valign="middle" align="center" style="padding-left: 1px; padding-right: 5px;">  
                                                <img alt="" style="height: 18px; width: 1px; vertical-align: middle;" src="../../Content/images/common/line_grey.gif">
                                            </td>
                                            ...
                                            <td valign="middle" align="center" onmouseout="this.className = 'toolbaritem_off';" onmouseover="this.className = 'toolbaritem_on';" class="toolbaritem_off">  
                                                <a href="javascript:__doPostBack('lnkSave','')" title="Save" onclick="#" id="lnkSave">
                                                    <img alt="Save" style="vertical-align: middle;" 
                                                    src="../../Content/images/icon/menuitem_save_colour.gif">
                                                </a>
                                            </td>
                                              <td class="toolbaritem_off" align="center" valign="middle">
        &nbsp;
    </td>
                                            ...
                                            <td valign="middle" align="center" onmouseout="this.className = 'toolbaritem_off';" onmouseover="this.className = 'toolbaritem_on';" class="toolbaritem_off">
                                               <img src="../../Content/images/common/expandTasks.gif" 
                                                    id="ctl00_dshElement_Task_aecElementControlTask_ucProjectPlan_imgExpandAll"
                                                        ...
                                                        alt="Add new Tasks" title="Enter New Tasks" onclick="#">
                                            </td>
                                              <td class="toolbaritem_off" align="center" valign="middle">
        &nbsp;
    </td>
                            ...
                            <table cellspacing="0" cellpadding="0" border="0">
                                <tbody><tr>
                                    ...
                                    <select name="ctl00$phFormContent$cboProjectLevel" id="project"
                                                            ...
                                                            <option value="Project1" selected="selected">User 1</option>
