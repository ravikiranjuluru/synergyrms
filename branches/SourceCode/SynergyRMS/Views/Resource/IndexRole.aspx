...
<tr>
	...
	<td valign="middle" align="left" colspan="1" class="formDetailHR"><img height="1" width="100%" alt="" src="/images/hr.gif"></td>
       ...
       <tr>
            ...
            <td valign="middle" align="left" class="formDetail">
                <input type="text" onkeydown="com_pickbox_onKeyDown(event, this, 'ctl00_phFormContent_pbxPrimaryRole_lnkSelect', 'ctl00_phFormContent_pbxPrimaryRole_lnkRefresh', true);" maxlength="20" class="textBox" id="ctl00_phFormContent_pbxPrimaryRole_txtValue" name="ctl00$phFormContent$pbxPrimaryRole$txtValue"> 
    <a href="javascript:__doPostBack('ctl00$phFormContent$pbxPrimaryRole$lnkSelect','')" title="Select" id="ctl00_phFormContent_pbxPrimaryRole_lnkSelect"><img border="0" alt="Select" src="/images/pick.gif"></a>
        <a href="javascript:__doPostBack('ctl00$phFormContent$pbxPrimaryRole$lnkRefresh','')" title="Refresh" id="ctl00_phFormContent_pbxPrimaryRole_lnkRefresh"><img border="0" alt="Refresh" src="/images/refresh.gif"></a>
        <div style="display: inline;" id="ctl00_phFormContent_pbxPrimaryRole_divDescription">
            </div>
<input type="hidden" id="ctl00_phFormContent_pbxPrimaryRole_hdnDescription" name="ctl00$phFormContent$pbxPrimaryRole$hdnDescription">
                        ...
                        <td>
                            ...
                            <table cellspacing="0" cellpadding="0" style="width: 100%;" class="formTable" id="tblRoles">                
                                ...
                                <tbody><tr>
                                    ...
                                    <td align="left" style="width: 55%;" class="formTableColumnTitle">
                                        Description
                                    </td>                                    
                    ...
                    <tr>
                        <td>
                            <table cellspacing="0" cellpadding="0" style="border: 0pt none; width: 100%;">
                                <tbody><tr>
                                    <td align="left">
                                        <input type="button" value="Add Roles" class="button" id="ctl00_phFormContent_btnAddRoles" name="ctl00$phFormContent$btnAddRoles" onclick="__doPostBack('ctl00$phFormContent$btnAddRoles','')">
                                        <input type="button" value="Copy From" class="button" id="ctl00_phFormContent_btnCopyRolesFrom" name="ctl00$phFormContent$btnCopyRolesFrom" onclick="__doPostBack('ctl00$phFormContent$btnCopyRolesFrom','')">                        
                                    </td>
                                    <td>&nbsp;</td>
                                    <td align="right">
