    ...
    <tbody><tr>
        ...
        <tr>
                ...
                <td valign="middle" align="left" style="padding-top: 6px;">
                    <input type="submit" value="Add Interested Project" class="button" id="ctl00_phFormContent_ucInterestedProjects_btnAdd" name="ctl00$phFormContent$ucInterestedProjects$btnAdd">
                    <input type="submit" value="Copy From" class="button" id="ctl00_phFormContent_ucInterestedProjects_btnCopyFrom" name="ctl00$phFormContent$ucInterestedProjects$btnCopyFrom">
                    
                </td>
            
                <td valign="middle" align="right" style="padding-top: 6px; padding-left: 4px;">
                    <input type="submit" disabled="disabled" onclick="return com_selectiongrid_remove('ctl00_phFormContent_ucInterestedProjects', 'You have not selected any items to remove', '');" value="Remove" class="button" id="ctl00_phFormContent_ucInterestedProjects_btnRemove" name="ctl00$phFormContent$ucInterestedProjects$btnRemove">
                </td>
        ...
        <input type="hidden" value="true" id="ctl00_phFormContent_ucInterestedProjects_hdnSelectedItems" name="ctl00_phFormContent_ucInterestedProjects_hdnSelectedItems">
